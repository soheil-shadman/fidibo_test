import 'package:fidibo_project/api/api.dart';
import 'package:fidibo_project/constants.dart';
import 'package:fidibo_project/routes.dart';
import 'package:fidibo_project/utils/random-image-giver.dart';
import 'package:fidibo_project/widgets/pages/home_page.dart';
...
class MyApp extends StatelessWidget {
  ...
  static void showSnackBar(BuildContext context,
    ...
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      backgroundColor:
          isError ? Constants.COLOR_RED_ERROR : Constants.COLOR_GREEN,
      content: Text(
        content,
